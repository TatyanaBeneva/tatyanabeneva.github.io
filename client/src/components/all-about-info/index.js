            ...
            <ul style={{ padding: 0 }}>
                <Li style={{ border: `5px solid #00cf4b` }} id="before">
                    ...
                    <P>
                        ...
                        basic html. So my journey into the world of programming began!
                    </P>
                </Li>
                ...
                <Li style={{ border: '5px solid #ff0040' }} id="now">
                    ...
                    <P>
                        ...
                        Express JS, Mongo DB, Firebase, GitHub, REST, C#, Unit testing. At the moment I do
                        not have much experience, but I have a great passion and desire to learn and grow.
                    </P>
                </Li>
            </ul>
        </Div>
